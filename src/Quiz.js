...
const Quiz = ({ user }) => {
    ...
    return (
        <>
            {showquiz1 ? (
                <Quiz1 marks={marks} setMarks={setMarks} user={user} />
            ) : (
                <Wrapper1>
                    <Wrapper onSubmit={handleSubmit}>
                        <Question>Q1. Choose your favorite Web language:</Question>
                        <Wrapper2>
                        ...
                        <Wrapper2>
                            ...
                            <RadioInput
                                ...
                                onChange={handleRadioChange}
                            />
                            <RadioLabel htmlFor="css" on={handleRadioChange}>CSS</RadioLabel>
